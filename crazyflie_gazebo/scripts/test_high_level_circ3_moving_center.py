...
import tf
import crazyflie
import crazymath_moving_center
import time
...
if __name__ == '__main__':
    ...
    for i in range(steps):
        ...
        cf1_params, cf2_params, cf3_params, p_12, p_23 = paramCalc.calculate(current_position1.x, current_position1.y, current_position2.x, current_position2.y, current_position3.x, current_position3.y, CX, CY)
