...
if __name__ == '__main__':
    ...
    for i in range(steps):
        cf1_params, cf2_params, cf3_params, p_12, p_23, distance_12, angle_1_APF, angle_2_APF = paramCalc.calculate(current_position1.x, current_position1.y, current_position2.x, current_position2.y, current_position3.x, current_position3.y)
        ...
        if i == 0:
            init_log(i=i, T_Z=T_Z, CX=CX, CY=CY, k=k, R=R, D_12=D_12, D_23=D_23,
                     safety_radius = safety_radius, eta_vf = eta_vf, eta_apf = eta_apf,
                     v_f=v_f, v_cruise=v_cruise, k_f=k_f, p_12=p_12, p_23=p_23,
                     distance_12 = distance_12, angle_1_APF = angle_1_APF, angle_2_APF = angle_2_APF,
